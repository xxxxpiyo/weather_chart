function execute(){
  ...
  success: function(json){
    ...
    $("#now").text(data['dateTime']);
    $("#outtemp").text(data['outTemp']);
    $("#intemp").text(data['inTemp']);
    $("#outhum").text(data['outHumidity']);
    $("#inhum").text(data['inHumidity']);
    $("#windspeed").text(data['windSpeed']);
    $("#altimeter").text(data['altimeter']);
    $("#dayrain").text(data['dayrain']);
  }  
  });
